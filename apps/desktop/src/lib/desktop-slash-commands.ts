...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/bg', description: 'Run a prompt in the background', aliases: ['/background'], surface: exec() },
  { name: '/btw', description: 'Ask a side question about this conversation', surface: exec() },
