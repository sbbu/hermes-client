...
describe('useHermesConfig refreshHermesConfig', () => {
  ...
  it('does not let a stale forced config refresh overwrite newer selector intent', async () => {
    ...
    setCurrentFastMode(false)
    profileConfig.resolve({ agent: { reasoning_effort: 'low', service_tier: 'priority' } })
